...
export class FsConnectorRegistry implements ConnectorRegistry {
  ...
  // FIXME: CLAUDE: I think this FS registry needs to at least have a config value that tells it where it should look for, at max, prefixed packages so that the import statement can try to load directly from that location.
