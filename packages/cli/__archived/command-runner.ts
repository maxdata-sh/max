...
import { ProjectDaemonManager, CliPrinter } from "../../app/src/project-daemon-manager.js";
...
export class CommandRunner {
  ...
  private daemon: ProjectDaemonManager;
  ...
  private constructor(
    ...
    this.daemon = new ProjectDaemonManager(config, printer);
  }
