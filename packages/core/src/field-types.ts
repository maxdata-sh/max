...
export type EntityFieldsPick<E extends EntityDefAny, K extends keyof EntityFields<E>> = {
  [P in K]: EntityFields<E>[P]
}

export type EntityFieldsKeys<E extends EntityDefAny> = keyof EntityFields<E> & string
